...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <motion.aside
        className={`bg-gradient-to-b from-gray-800 to-gray-900 border-r border-gray-700/50 min-h-screen shadow-xl ${
      ...
      <nav className="p-4" style={{ pointerEvents: 'auto', zIndex: 1 }}>
